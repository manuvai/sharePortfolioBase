...
public class PortefeuilleTest {
    ...
    public void testVendreActionComposeeQteTotaleOK() throws Exception {
        ...
        // THEN
        Assertions.assertDoesNotThrow(() -> portefeuille.vendre(action, 2),
                "You should be able to sell all actions than you have");
    ...
    public void testAcheterActionSimpleQuantiteTotaleOK() throws Exception {
        ...
        // THEN
        Assertions.assertTrue(portefeuille.mapLignes.containsKey(action),
                "L'action doit être présente dans le portefeuille");
...
>>>>>>> main
    ...
    public void testEvolutionValeurTotalPortefeuille() {
        ...
        // calculer
        final double expectedTotalValue = (30.0 * 2 + 20.0 * 0.5 * 100 + 50.0 * 0.5 * 100)
                - (15.0 * 2 + 12.0 * 0.5 * 100 + 11.0 * 0.5 * 100);
        ...
        Assertions.assertEquals(expectedTotalValue, actualTotalValue,
                "VisualisationEvolutionValeurTotalPortefeuille KO");
    }
    ...
    public void testNombreActionsAchetablesActionSimple() throws Exception {
        ...
        // THEN
        Assertions.assertEquals(83, nombreAchetables,
                "Le nombre d'actions achetables pour l'action simple est incorrect.");
    }
    ...
    public void testNombreActionsAchetablesActionComposee() throws Exception {
        ...
        // THEN
        Assertions.assertEquals(74, nombreAchetables,
                "Le nombre d'actions achetables pour l'action composée est incorrect.");
    }
}
